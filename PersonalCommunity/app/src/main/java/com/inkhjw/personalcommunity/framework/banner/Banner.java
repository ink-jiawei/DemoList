...
public class Banner extends FrameLayout implements OnPageChangeListener {
    ...
    private int mIndicatorSelectedResId = R.drawable.checked_indicator;
    private int mIndicatorUnselectedResId = R.drawable.unchecked_indicator;
    ...
    private void handleTypedArray(Context context, AttributeSet attrs) {
        ...
        mIndicatorWidth = typedArray.getDimensionPixelSize(R.styleable.Banner_indicator_width, getResources().getDimensionPixelOffset(R.dimen.x5));
        mIndicatorHeight = typedArray.getDimensionPixelSize(R.styleable.Banner_indicator_height, getResources().getDimensionPixelOffset(R.dimen.x5));
        mIndicatorMargin = typedArray.getDimensionPixelSize(R.styleable.Banner_indicator_margin, getResources().getDimensionPixelOffset(R.dimen.x3));
        mIndicatorSelectedResId = typedArray.getResourceId(R.styleable.Banner_indicator_drawable_selected, R.drawable.checked_indicator);
        mIndicatorUnselectedResId = typedArray.getResourceId(R.styleable.Banner_indicator_drawable_unselected, R.drawable.unchecked_indicator);
    ...
    private void createIndicator() {
        ...
        for (int i = 0; i < count; i++) {
            ...
            LinearLayout.LayoutParams params = new LinearLayout.LayoutParams(getResources().getDimensionPixelOffset(R.dimen.x5), getResources().getDimensionPixelOffset(R.dimen.x5));
            params.leftMargin = getResources().getDimensionPixelOffset(R.dimen.x2);
            params.rightMargin = getResources().getDimensionPixelOffset(R.dimen.x2);
            if (i == 0) {
