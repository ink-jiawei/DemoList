 ...
 * 优选商品
 */
public class OptimizationActivity extends SpeicalToolbarActivity {
    //toolbar
    ...
    public void initRecycleView() {
        ...
        for (int i = 0; i < 3; i++) {
            shopLists.add(new ShopListBean(false, R.drawable.iphone6s, "iphone 6s 128G", 1000, 234));
        }
            ...
            public void onScrollStateChanged(RecyclerView recyclerView, int newState) {
                ...
                if (newState == AbsListView.OnScrollListener.SCROLL_STATE_IDLE) {
                    ...
                    if (lostPos == layoutManager.getItemCount() - 1) {
                        ToastHelper.showToast(OptimizationActivity.this, "到底了！");
                    }
                }
            }
        });
