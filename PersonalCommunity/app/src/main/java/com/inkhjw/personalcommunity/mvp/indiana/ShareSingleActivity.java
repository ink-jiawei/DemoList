 ...
 * 晒单
 */
public class ShareSingleActivity extends NoSupportStatusBackActivity {
    ...
    protected void init() {
        super.init();
        setSupportToolbar(R.drawable.toolbar_back_black, getTextFromId(R.string.indiana_share_im), R.drawable.indiana_share_single);
    }
