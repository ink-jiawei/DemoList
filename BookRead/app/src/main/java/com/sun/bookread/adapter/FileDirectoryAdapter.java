...
public class FileDirectoryAdapter extends BaseAdapter {
    ...
    public FileDirectoryAdapter(Context context, ArrayList<String> na, ArrayList<String> pa) {
        names = na;
        paths = pa;
        directory = BitmapFactory.decodeResource(context.getResources(), R.mipmap.icon_wenjianjia);
        file = BitmapFactory.decodeResource(context.getResources(), R.mipmap.icon_wenjian);
        //缩小图片
