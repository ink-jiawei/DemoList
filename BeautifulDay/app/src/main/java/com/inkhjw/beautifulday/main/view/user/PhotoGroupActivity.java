...
import com.inkhjw.beautifulday.adapter.PhotoGroupAdapter;
...
public class PhotoGroupActivity extends BaseActivity {
    @Bind(R.id.image_num)
    TextView image_num;
    @Bind(R.id.photogroup_gridview)
    GridView photogroup_gridview;
    ...
    @OnItemClick(R.id.photogroup_gridview)
